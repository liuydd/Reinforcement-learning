...
from lib.UpperConfidenceBound import UCBMultiArmedBandit
from lib.UCBLinearBandit import UCBLinearBandit
from lib.ThompsomSampling import TSMultiArmedBandit
from lib.TSLinearBandit import TSLinearBandit
from lib.PerturbedhistoryExploration import PHEMultiArmedBandit
...
if __name__ == '__main__':
	...
	NoiseScale = 0.1  # standard deviation of Gaussian noise 1.2可以修改的
	n_articles = 2
	n_users = 10
	...
	# algorithms['UCBMultiArmedBandit'] = UCBMultiArmedBandit(num_arm=n_articles, NoiseScale=NoiseScale)
	algorithms['UCBLinearBandit'] = UCBLinearBandit(dimension=context_dimension, lambda_=0.1, alpha=0.5)
	# algorithms['TSMultiArmedBandit'] = TSMultiArmedBandit(num_arm=n_articles, NoiseScale=NoiseScale)
	algorithms['TSLinearBandit'] = TSLinearBandit(dimension=context_dimension, lambda_=0.1, sigma=0.5)
	# algorithms['PHEMultiArmedBandit'] = PHEMultiArmedBandit(num_arm=n_articles, alpha=20)
	algorithms['PHELinearBandit'] = PHELinearBandit(dimension=context_dimension, lambda_=0.1, alpha=1)
